...
const gameList = [
  {selectNumber:'1', question:'ニンジンを握りしめながら泣いている少女。一体何があった？', answer:'雪だるまが溶けてしまい、地面に残ったニンジンの鼻を拾っていた少女であった。', icon:'にんじん'},
  {selectNumber:'2', question:'男がバーに入り、バーテンダーに1杯の水を求めた。しかしバーテンダーは、水を出す代わりに銃を出して男に向けた。すると男は「ありがとう」と言い残して店を出て行った。何が起こったのだろうか？', answer:'男はしゃっくりが止まらなかった。男はバーに立ち寄り、しゃっくりを止める為に水を一杯注文した。そこでマスターは機転を利かせ、男に銃を突きつけた。銃を突きつけられてびっくりした男はしゃっくりが止まり、マスターに「ありがとう」と言ってバーを去っていった。', icon:'銃'},
  {selectNumber:'3', question:'お湯に入れてかき混ぜるだけで完成。新商品「ラテラテベジタブル」。パッケージにはみずみずしい有機野菜や果物が描かれていて、それなりに売れていた。しかし、あるときからパッケージがそこまで美味しそうじゃない、どんよりとした緑一色になってしまった。一体なぜだろうか。', answer:'新商品は「入浴剤」だった。パッケージがあまりにもスープらしい見た目だったので、誤飲を防ぐためにパッケージを変更したのだ。', icon:'健康'},
  {selectNumber:'4', question:'僕は身に着けていたものをたくさん奪われたのになんだか気分が良い！一体なぜだろうか？', answer:'後輩や同級生からモテていた男は卒業式の日に制服のボタンを全部取られて嬉しくなった。', icon:'男'},
  ...
  {selectNumber:'6', question:'お金を投げて遊ぶタロウはいつも両親に怒られていた。しかし今日はお金を投げても怒られず、むしろ両親は微笑んでいた。なぜだろうか？', answer:'今日投げたものは賽銭だった。', icon:'お金'}
]
