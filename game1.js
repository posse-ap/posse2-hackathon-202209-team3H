...
const gameList = [
  ...
  {selectNumber:'2', question:'直輝さんがバーに入り、バーテンダーに1杯の水を求めた。しかしバーテンダーは、水を出す代わりに銃を出して直輝さんに向けた。すると男は「ありがとう」と言い残して店を出て行った。何が起こったのだろうか？', answer:'男はしゃっくりが止まらなかった。男はバーに立ち寄り、しゃっくりを止める為に水を一杯注文した。そこでマスターは機転を利かせ、男に銃を突きつけた。銃を突きつけられてびっくりした男はしゃっくりが止まり、マスターに「ありがとう」と言ってバーを去っていった。', icon:'銃'},
  ...
  {selectNumber:'6', question:'お金を投げて遊ぶ直輝さんはいつも運営さんに怒られていた。しかし今日はお金を投げても怒られず、むしろ運営さんは微笑んでいた。なぜだろうか？', answer:'今日直輝さんが投げたものは賽銭だった。', icon:'お金'}
]
